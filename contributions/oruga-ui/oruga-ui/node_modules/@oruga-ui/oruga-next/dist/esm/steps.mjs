...
import { u as useProviderParent, a as useProviderChild } from "./useParentProvider-CilmDxOR.mjs";
                ...
                default: withCtx(() => [
                  createElementVNode("div", {
                    ...
                    childItem.icon ? (openBlock(), createBlock(_sfc_main$2, {
                      ...
                      size: __props.size
                    }, null, 8, ["icon", "pack", "size"])) : childItem.step ? (openBlock(), createElementBlock("span", _hoisted_3, toDisplayString(childItem.step), 1)) : createCommentVNode("", true)
                  ], 2),
                  createElementVNode("div", {
