...
const ssr = require("./ssr-Dxg1sorJ.cjs");
const defineClasses = require("./defineClasses-J4JSA2wk.cjs");
const usePropValue = require("./usePropValue-BtiZZeMW.cjs");
const useEventListener = require("./useEventListener-DpQztptF.cjs");
const useInputHandler = require("./useInputHandler-CqchPslD.cjs");
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const hoveredOption = vue.ref(null);
    ...
    function setHoveredIdToIndex(index) {
      const element = ssr.unrefElement(itemRefs.value[index]);
    ...
    function navigateItem(direction) {
      ...
      const element = ssr.unrefElement(items[index]);
      if (!element)
        return;
      hoveredId.value = element.id;
      const dropdownMenu = ssr.unrefElement(dropdownRef.value.$content);
    ...
    vue.watch(
      () => props.debounce,
      (value) => {
        debouncedInput = useDebounce.useDebounce(emitInput, value);
      }
    );
      ...
      return vue.openBlock(), vue.createBlock(DropdownItem_vue_vue_type_script_setup_true_lang._sfc_main, {
        ...
        trigger: vue.withCtx(() => [
          vue.createVNode(Input_vue_vue_type_script_setup_true_lang._sfc_main, vue.mergeProps({
            ...
            modelValue: vue.unref(vmodel),
            "onUpdate:modelValue": [
              _cache[0] || (_cache[0] = ($event) => vue.isRef(vmodel) ? vmodel.value = $event : null),
              onInput
            ],
            type: __props.type,
            size: __props.size,
...
//# sourceMappingURL=Autocomplete.vue_vue_type_script_setup_true_lang-CNTi-eq9.cjs.map
