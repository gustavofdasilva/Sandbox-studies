                ...
                default: vue.withCtx(() => [
                  vue.createElementVNode("div", {
                    ...
                    childItem.icon ? (vue.openBlock(), vue.createBlock(Icon_vue_vue_type_script_setup_true_lang._sfc_main, {
                      ...
                      size: __props.size
                    }, null, 8, ["icon", "pack", "size"])) : childItem.step ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_3, vue.toDisplayString(childItem.step), 1)) : vue.createCommentVNode("", true)
                  ], 2),
                  vue.createElementVNode("div", {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.Transition, {
        disabled: !vue.unref(parent).animated,
        ...
        default: vue.withCtx(() => [
          vue.withDirectives(vue.createElementVNode("div", {
            ref: "rootRef",
            class: vue.normalizeClass(vue.unref(elementClasses)),
