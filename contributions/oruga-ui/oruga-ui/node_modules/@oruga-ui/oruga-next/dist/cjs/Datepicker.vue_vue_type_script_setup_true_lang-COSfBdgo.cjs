...
const Button_vue_vue_type_script_setup_true_lang = require("./Button.vue_vue_type_script_setup_true_lang-BPOXNSgn.cjs");
const Select_vue_vue_type_script_setup_true_lang = require("./Select.vue_vue_type_script_setup_true_lang-BocgvaqW.cjs");
const utils = require("./utils-CULZcX7o.cjs");
const defineClasses = require("./defineClasses-J4JSA2wk.cjs");
const helpers = require("./helpers.cjs");
const config = require("./config-CtW04cuF.cjs");
const useMatchMedia = require("./useMatchMedia-CnMQFGfR.cjs");
function useDatepickerMixins(props) {
  ...
  const defaultDateParser = (date) => {
    ...
    if (dtf.value.formatToParts && typeof dtf.value.formatToParts === "function") {
      ...
      const dateGroups = utils.matchWithGroups(formatRegex, date);
...
const _sfc_main$3 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const datepicker = vue.computed(() => props.pickerProps);
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        datepicker.value.showWeekNumber ? (vue.openBlock(), vue.createElementBlock("div", {
          key: 0,
        ...
        ], 46, _hoisted_1$2)) : vue.createCommentVNode("", true),
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.week, (weekDay, idx) => {
          return vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: idx }, [
            !datepicker.value.disabled && vue.unref(isDateSelectable)(weekDay, __props.month) ? (vue.openBlock(), vue.createElementBlock("div", {
              key: 0,
              ref_for: true,
            ...
            ], 42, _hoisted_2$2)) : (vue.openBlock(), vue.createElementBlock("div", {
              key: 1,
              class: vue.normalizeClass(cellClasses(weekDay))
            }, [
              vue.createElementVNode("span", null, vue.toDisplayString(weekDay.getDate()), 1)
...
const _sfc_main$2 = /* @__PURE__ */ vue.defineComponent({
  ...
  emits: /* @__PURE__ */ vue.mergeModels(["update:modelValue", "update:focusedDate", "range-start", "range-end", "week-number-click"], ["update:focusedDate"]),
  setup(__props, { emit: __emit }) {
    const props = __props;
    const emits = __emit;
    const { isDateSelectable } = useDatepickerMixins(props.pickerProps);
    ...
    const hoveredDateRange = vue.computed(() => {
      if (!datepicker.value.range || selectedEndDate.value)
        return [];
      return (hoveredEndDate.value < selectedBeginDate.value ? [hoveredEndDate.value, selectedBeginDate.value] : [selectedBeginDate.value, hoveredEndDate.value]).filter(helpers.isDefined);
    });
        ...
        vue.createElementVNode("div", {
          ...
          vue.createElementVNode("div", {
            ...
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(monthDates.value, (date, idx) => {
              return vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: idx }, [
                !datepicker.value.disabled && isDateSelectable(date) ? (vue.openBlock(), vue.createElementBlock("div", {
                  key: 0,
                  ref_for: true,
                  ...
                  eventsDateMatch(date).length ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$1, [
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  props: /* @__PURE__ */ vue.mergeModels({
    ...
    dayNames: {
      type: Array,
      default: () => config.getOption("datepicker.dayNames", void 0)
    },
    /** Set custom month names, else use names based on locale */
    monthNames: {
      type: Array,
      default: () => config.getOption("datepicker.monthNames", void 0)
    },
    /**
    ...
    size: {
      type: String,
      default: () => config.getOption("datepicker.size")
    },
    ...
    openOnFocus: {
      type: Boolean,
      default: () => config.getOption("datepicker.openOnFocus", true)
    },
    /** Close dropdown on click */
    closeOnClick: {
      type: Boolean,
      default: () => config.getOption("datepicker.closeOnClick", true)
    },
    /** Date format locale */
    locale: {
      type: String,
    ...
    dateFormatter: {
      type: Function,
      default: (date, defaultFunction) => config.getOption("datepicker.dateFormatter", defaultFunction)(date)
    },
    /** Custom function to parse a string into a date */
    dateParser: {
      type: Function,
      default: (date, defaultFunction) => config.getOption("datepicker.dateParser", defaultFunction)(date)
    },
    /** Date creator function, default is `new Date()` */
    dateCreator: {
      type: Function,
      default: () => config.getOption("datepicker.dateCreator", () => /* @__PURE__ */ new Date())()
    },
    ...
    unselectableDaysOfWeek: {
      type: Array,
      default: () => config.getOption("datepicker.unselectableDaysOfWeek", void 0)
    },
    /** Show nearby month days */
    nearbyMonthDays: {
      type: Boolean,
      default: () => config.getOption("datepicker.nearbyMonthDays", true)
    },
    /** Define if nearby month days can be selected */
    nearbySelectableMonthDays: {
      type: Boolean,
      default: () => config.getOption("datepicker.nearbySelectableMonthDays", false)
    },
    /** Show weeek numbers */
    showWeekNumber: {
      type: Boolean,
      default: () => config.getOption("datepicker.showWeekNumber", false)
    },
    /** Define if weeek numbers are clickable */
    weekNumberClickable: {
      type: Boolean,
      default: () => config.getOption("datepicker.weekNumberClickable", false)
    },
    /** Set the first day of a week */
    firstDayOfWeek: {
      type: Number,
      default: () => config.getOption("datepicker.firstDayOfWeek", 0)
    },
    ...
    yearsRange: {
      type: Array,
      default: () => config.getOption("datepicker.yearsRange", [-100, 10])
    },
    /** Trap dropdown on focus */
    trapFocus: {
      type: Boolean,
      default: () => config.getOption("datepicker.trapFocus", true)
    },
    ...
    mobileModal: {
      type: Boolean,
      default: () => config.getOption("datepicker.mobileModal", true)
    },
    /** Enable mobile native input if mobile agent */
    mobileNative: {
      type: Boolean,
      default: () => config.getOption("datepicker.mobileNative", true)
    },
    /**
     * Icon pack to use
    ...
    iconPack: {
      type: String,
      default: () => config.getOption("datepicker.iconPack", void 0)
    },
    /** Icon to be shown */
    icon: {
      type: String,
      default: () => config.getOption("datepicker.icon", void 0)
    },
    /** Icon to be added on the right side */
    iconRight: {
      type: String,
      default: () => config.getOption("datepicker.iconRight", void 0)
    },
    ...
    iconPrev: {
      type: String,
      default: () => config.getOption("datepicker.iconPrev", "chevron-left")
    },
    /** Icon name for next icon */
    iconNext: {
      type: String,
      default: () => config.getOption("datepicker.iconNext", "chevron-right")
    },
    /** Mobile breakpoint as max-width value */
    mobileBreakpoint: {
      type: String,
      default: () => config.getOption("datepicker.mobileBreakpoint")
    },
    /**
    ...
    teleport: {
      ...
      default: () => config.getOption("datepicker.teleport", false)
    },
    ...
    ariaNextLabel: {
      type: String,
      default: () => config.getOption("datepicker.ariaNextLabel", "Next Page")
    },
    /** Accessibility previous button aria label  */
    ariaPreviousLabel: {
      type: String,
      default: () => config.getOption("datepicker.ariaNextLabel", "Previous Page")
    },
    ...
    inputClasses: {
      type: Object,
      default: () => config.getOption("datepicker.inputClasses", {})
    },
    /**
    ...
    selectClasses: {
      type: Object,
      default: () => config.getOption("datepicker.selectClasses", {})
    }
  }, {
    "modelValue": {},
    "modelModifiers": {},
  ...
  emits: /* @__PURE__ */ vue.mergeModels(["update:modelValue", "update:active", "range-start", "range-end", "change-month", "change-year", "focus", "blur", "invalid", "icon-click", "icon-right-click"], ["update:modelValue", "update:active"]),
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const computedDayNames = vue.computed(() => {
      ...
      return utils.getWeekdayNames(props.locale);
    });
      ...
      return vue.openBlock(), vue.createBlock(utils._sfc_main, {
        ...
        default: vue.withCtx(() => [
          vue.createElementVNode("header", {
            ...
            vue.renderSlot(_ctx.$slots, "header", {}, () => [
              vue.createElementVNode("div", {
                ...
                !__props.disabled ? (vue.openBlock(), vue.createBlock(Button_vue_vue_type_script_setup_true_lang._sfc_main, {
                  key: 0,
                ...
                vue.createElementVNode("div", {
                  ...
                  !isTypeMonth.value ? (vue.openBlock(), vue.createBlock(Select_vue_vue_type_script_setup_true_lang._sfc_main, vue.mergeProps({
                    key: 0,
                    ...
                    default: vue.withCtx(() => [
                      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(listOfMonths.value, (month) => {
                        return vue.openBlock(), vue.createElementBlock("option", {
                          key: month.name,
                          value: month.index,
                          disabled: month.disabled
                        }, vue.toDisplayString(month.name), 9, _hoisted_1);
                      }), 128))
                    ]),
                    _: 1
                  }, 16, ["modelValue", "disabled", "size"])) : vue.createCommentVNode("", true),
                  vue.createVNode(Select_vue_vue_type_script_setup_true_lang._sfc_main, vue.mergeProps({
                    ...
                    default: vue.withCtx(() => [
                      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(listOfYears.value, (year) => {
                        return vue.openBlock(), vue.createElementBlock("option", {
                          key: year,
                          value: year
                        }, vue.toDisplayString(year), 9, _hoisted_2);
                      }), 128))
                    ]),
                    _: 1
          ...
          vue.renderSlot(_ctx.$slots, "body", {}, () => [
            ...
            }, null, 8, ["modelValue", "focused-date", "month-names", "picker-props"])) : (vue.openBlock(), vue.createBlock(_sfc_main$2, {
              key: 1,
              modelValue: vmodel.value,
...
//# sourceMappingURL=Datepicker.vue_vue_type_script_setup_true_lang-COSfBdgo.cjs.map
