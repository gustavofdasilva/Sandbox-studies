...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function addHandler() {
      if (ssr.isClient && !scrollingParent.value && props.content) {
        scrollingParent.value = getScrollingParent(ssr.unrefElement(props.content));
    ...
    function updatePositioning() {
      ...
      if (!props.teleport)
        return;
      const content = ssr.unrefElement(props.content);
      const trigger = ssr.unrefElement(props.trigger);
      if (content && trigger) {
    ...
    function getAutoPosition() {
      ...
      const contentRect = ssr.unrefElement(props.content).getBoundingClientRect();
      const triggerRect = ssr.unrefElement(props.trigger).getBoundingClientRect();
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.Teleport, {
        ...
        disabled.value ? vue.renderSlot(_ctx.$slots, "default", { key: 0 }) : (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({ key: 1 }, _ctx.$attrs, { style: { position: "absolute", left: "0px", top: "0px" } }), [
...
//# sourceMappingURL=PositionWrapper.vue_vue_type_script_setup_true_lang-CtVcMUFD.cjs.map
