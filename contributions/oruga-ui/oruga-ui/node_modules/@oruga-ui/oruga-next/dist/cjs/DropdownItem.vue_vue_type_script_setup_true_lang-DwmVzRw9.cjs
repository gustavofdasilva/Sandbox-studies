...
const PositionWrapper_vue_vue_type_script_setup_true_lang = require("./PositionWrapper.vue_vue_type_script_setup_true_lang-CtVcMUFD.cjs");
const config = require("./config-CtW04cuF.cjs");
const trapFocus = require("./trapFocus-D3km7Dtd.cjs");
...
const useClickOutside = require("./useClickOutside-Cd8CrVrr.cjs");
...
const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    function checkDropdownScroll() {
      const dropdown = ssr.unrefElement(contentRef.value);
...
//# sourceMappingURL=DropdownItem.vue_vue_type_script_setup_true_lang-DwmVzRw9.cjs.map
