...
const useFieldShare = require("./useFieldShare-DlH0gGzs.cjs");
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        __props.type !== "textarea" ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("input", vue.mergeProps({ key: 0 }, _ctx.$attrs, {
          ...
          [vue.vModelDynamic, vue.unref(vmodel)]
        ]) : vue.withDirectives((vue.openBlock(), vue.createElementBlock("textarea", vue.mergeProps({ key: 1 }, _ctx.$attrs, {
          ref_key: "textareaRef",
          ref: textareaRef,
          "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => vue.isRef(vmodel) ? vmodel.value = $event : null),
          ...
          [vue.vModelText, vue.unref(vmodel)]
        ]),
...
//# sourceMappingURL=Input.vue_vue_type_script_setup_true_lang-CveAfxfc.cjs.map
